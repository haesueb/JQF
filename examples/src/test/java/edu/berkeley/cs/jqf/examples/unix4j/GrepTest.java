...
//        System.out.println(out);
    ...
    @Fuzz
    public void testWithStringGenerator(@From(AlphaStringGenerator.class) String input1, @From(AlphaStringGenerator.class) String input2, @FrameworkProvided boolean config){
        ...
        if (config){
            ...
            assumeTrue(contain);
            String out = Unix4j.fromString(input1).grep(Grep.Options.v, input2).toStringResult();
            // pattern = input1
